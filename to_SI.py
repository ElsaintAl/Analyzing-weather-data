...
df = pd.read_csv('eleusis_2024_8.csv')
df = df.drop(32)
...
df['Wind Speed (mps)'] = [converter.clean_temp(x, len=9) for x in df['Wind Speed (mph)']]
...
path = fr"C:\Users\SpaceYellow\Desktop\Python\Projects\Weather\SI_eleusis_2024_8.csv"
